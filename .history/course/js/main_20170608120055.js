...
function setUpdate(id){
    ...
    document.getElementById('desc').material_select();
    document.getElementById('amount').material_select();
    document.getElementById('valor').material_select();
    document.getElementById('btnUpdat').material_select();
    document.getElementById('btnAdd').material_select();
