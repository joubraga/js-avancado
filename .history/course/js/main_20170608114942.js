...
function setList(list){
    ...
    for(let key in list){
        table += '<tr><td>'+ formatDesc(list[key].desc) +'</td><td>'+list[key].amount+'</td><td>'+ formatValue(list[key].value) +'</td><td> <button onclick="setUpdate('+key+');">Edit</button> | Delete </td></tr>';
    }
    table +='</tbody>';
